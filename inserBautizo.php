<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        empty($_POST['estado_de_nacimiento']) || empty($_POST['dia_de_nacimiento']) || empty($_POST['mes_de_nacimiento']) ||
...
<div class="header">
    ...
    <form class="formulario-estilizado" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
        ...
        <div class="input-row">
            ...
            <div class="input-group">
                <label for="estado_de_nacimiento">Estado de Nacimiento:</label><br>
