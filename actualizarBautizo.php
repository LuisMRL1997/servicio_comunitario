...
<html>
<head>
    <title>Actualizar Bautizo</title>
...
<div class="header">
    ...
    <div class="menu-bar">
            ...
            <button id="cerrarSesion" onclick="window.location.href='indexBautizo.php'">Volver</button>
            <?php
  ...
  $finalidad=$_GET["finalidad"];
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if (empty($_POST['nom1']) || empty($_POST['ape1']) ||
            ...
            empty($_POST['apeminis1']) || empty($_POST['num_reg_civil']) || empty($_POST['ano_reg_civil']) ||
            empty($_POST['estado_nac']) || empty($_POST['numLibro']) || empty($_POST['folio']) || empty($_POST['numeral'])) {          
